...
export default function BlogEditorPage() {
  ...
  const setNested = (parent, key, val) => setForm((prev) => ({ ...prev, [parent]: { ...prev[parent], [key]: val } }));
              ...
              <div style={{ marginTop: 12 }}>
                ...
                <div style={s.seoPreview}>
                  ...
                  <div style={{ color: "#006621", fontSize: 11, marginBottom: 4 }}>
                    counselorscafe.com/blog/{form.title ? form.title.toLowerCase().replace(/[^a-z0-9]+/g, "-").replace(/(^-|-$)/g, "") : "post-slug"}
                  </div>
