...
export const metadata: Metadata = {
  title: "Download The Counselors Cafe App | Career Guidance on Your Phone",
  description: "Download The Counselors Cafe mobile app for iOS & Android. Get personalized career guidance, book sessions with expert counselors, and manage your career journey on the go. Free to download.",
  keywords: [
  ...
  alternates: {
    canonical: "https://thecounselorscafe.com/download-app",
  },
  openGraph: {
    title: "Download The Counselors Cafe App | Career Guidance on Your Phone",
    ...
    url: "https://thecounselorscafe.com/download-app",
