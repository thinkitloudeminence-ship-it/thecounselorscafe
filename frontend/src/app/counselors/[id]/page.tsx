...
// // @ts-ignore: CounselorDetailClient.tsx is treated as a script by TypeScript, ignore module resolution here.
...
export async function generateMetadata(
  ...
  return {
    title: `${names[id] || "Counselor"} | counselors cafe`,
    description: "Book a session with a verified career counselor.",
  };
}
