...
export default function HeroSection() {
  ...
  // ============================================================
  // 🎨 COLOR COMBINATION 1: NAVY + GOLD (Current)
  // ============================================================
  const color1 = {
    sectionBg: "#0a192f",
  ...
  // ============================================================
  // 🎨 COLOR COMBINATION 2: DARK + EMERALD GREEN
  // ============================================================
  const color2 = {
    sectionBg: "#0a1a1a",
  ...
  // ============================================================
  // 🎨 COLOR COMBINATION 3: DARK + ROYAL PURPLE
  // ============================================================
  const color3 = {
    sectionBg: "#0f0a1a",
  ...
  // ============================================================
  // 🎨 COLOR COMBINATION 4: DARK + ROSE/CORAL
  // ============================================================
  const color4 = {
    sectionBg: "#1a0f0f",
  ...
  // ============================================================
  // 🎨 COLOR COMBINATION 5: DARK + CYAN/TEAL
  // ============================================================
  const color5 = {
    sectionBg: "#0a1414",
  ...
  // ============================================================
  // 🎨 COLOR COMBINATION 6: PURE BLACK + GOLD (Premium)
  // ============================================================
  const color6 = {
    sectionBg: "#000000",
    primary: "from-amber-400 to-amber-600",
  ...
  // ============================================================
  // 🎨 COLOR COMBINATION 8: DARK + INDIGO
  // ============================================================
  const color8 = {
    sectionBg: "#0a0a1a",
  ...
  // ============================================================
  // 🎨 COLOR COMBINATION 9: DARK + ORANGE
  // ============================================================
  const color9 = {
    sectionBg: "#1a0f0a",
  ...
  // ============================================================
  // 🎨 COLOR COMBINATION 10: DARK + BLUE (Professional)
  // ============================================================
  const color10 = {
    sectionBg: "#0a0f1a",
  ...
  // ============================================================
  // 🎨 COLOR COMBINATION 11: DARK + VIOLET
  // ============================================================
  const color11 = {
    sectionBg: "#0f0a1a",
  ...
  // ============================================================
  // 🎨 COLOR COMBINATION 12: DARK + AMBER (Warm Gold)
  // ============================================================
  const color12 = {
    sectionBg: "#0a0f0a",
    primary: "from-amber-400 to-amber-600",
  ...
  // ============================================================
  // 🎯 SELECT YOUR COLOR COMBINATION HERE
  // ============================================================
  // Change this variable to test different colors
    ...
    <>
      ...
      >
        ...
        <motion.div
          ...
          className={`absolute top-20 left-1/3 w-48 h-48 sm:w-64 sm:h-64 md:w-80 md:h-80 lg:w-96 lg:h-96 bg-${selectedColor.glow} rounded-full blur-[80px] sm:blur-[100px] md:blur-[120px] z-0 hidden sm:block`}
              ...
              <div className="flex flex-col lg:flex-row items-center lg:items-start justify-between gap-8 lg:gap-12">
                ...
                >
                  <h1 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-bold text-white leading-tight drop-shadow-lg">
                    ...
                    <span className={`bg-gradient-to-r ${selectedColor.from} ${selectedColor.to} bg-clip-text text-transparent`}>
                  ...
                  <div className="mt-4 sm:mt-5 md:mt-6 h-12 sm:h-14 md:h-16 lg:h-20">
                    ...
                    >
                      <span className={`text-base sm:text-lg md:text-xl lg:text-2xl xl:text-3xl font-bold bg-gradient-to-r ${selectedColor.from} ${selectedColor.to} bg-clip-text text-transparent drop-shadow-lg`}>
                  ...
                  <div className="flex flex-wrap justify-center lg:justify-start gap-2 sm:gap-3 md:gap-4 mt-4 sm:mt-5 md:mt-6">
                    <div className={`flex items-center gap-1.5 sm:gap-2 bg-black/40 backdrop-blur-sm rounded-full px-2 py-1 sm:px-3 sm:py-1.5 md:px-4`}>
                      <Star className={`w-3 h-3 sm:w-4 sm:h-4 ${selectedColor.text} ${selectedColor.fill}`} />
                      <span className="text-white text-xs sm:text-sm md:text-base">4.9 Rating</span>
                    </div>
                    <div className={`flex items-center gap-1.5 sm:gap-2 bg-black/40 backdrop-blur-sm rounded-full px-2 py-1 sm:px-3 sm:py-1.5 md:px-4`}>
                      <Users className={`w-3 h-3 sm:w-4 sm:h-4 ${selectedColor.text}`} />
                      <span className="text-white text-xs sm:text-sm md:text-base">10K+ Sessions</span>
                    </div>
                    <div className={`flex items-center gap-1.5 sm:gap-2 bg-black/40 backdrop-blur-sm rounded-full px-2 py-1 sm:px-3 sm:py-1.5 md:px-4`}>
                      <Award className={`w-3 h-3 sm:w-4 sm:h-4 ${selectedColor.text}`} />
                  ...
                  <button 
                    ...
                    className={`mt-5 sm:mt-6 md:mt-7 bg-gradient-to-r ${selectedColor.from} ${selectedColor.to} text-black px-4 sm:px-5 md:px-6 lg:px-8 py-2 sm:py-2.5 md:py-3 rounded-full font-semibold hover:from-opacity-80 hover:to-opacity-80 transition-all duration-300 text-xs sm:text-sm md:text-base inline-flex items-center gap-1.5 sm:gap-2 group shadow-lg`}
                  >
                    Talk to Expert 
          ...
          <div className="mt-6 sm:mt-8 md:mt-10 lg:mt-12 max-w-xl sm:max-w-2xl md:max-w-3xl mx-auto">
            <div className="flex flex-col sm:flex-row gap-2 bg-gray-900/80 backdrop-blur-sm rounded-xl sm:rounded-2xl p-1 border border-gray-700">
              <div className="flex-1 flex items-center gap-2 px-3 sm:px-4 md:px-5 py-2 sm:py-3 md:py-4">
                <MapPin className={`w-3.5 h-3.5 sm:w-4 sm:h-4 ${selectedColor.text} flex-shrink-0`} />
                <input
                  type="text"
              ...
              <button className={`bg-gradient-to-r ${selectedColor.from} ${selectedColor.to} text-black px-4 sm:px-5 md:px-6 py-2 sm:py-2.5 md:py-3 rounded-lg sm:rounded-xl text-xs sm:text-sm md:text-base font-semibold transition-all duration-300 inline-flex items-center justify-center gap-1.5 sm:gap-2`}>
            ...
            <div className="grid grid-cols-2 xs:grid-cols-3 sm:grid-cols-4 md:grid-cols-6 lg:grid-cols-8 gap-1.5 sm:gap-2 md:gap-3">
              {categories.map((item, i) => (
                <motion.div
                  ...
                  className={`px-2 sm:px-3 md:px-4 py-1.5 sm:py-2 bg-gray-800/60 backdrop-blur-sm text-white text-[10px] xs:text-xs sm:text-sm text-center rounded-full border border-gray-700 ${selectedColor.bgHover} ${selectedColor.textHover} ${selectedColor.borderHover} transition-all duration-300 cursor-pointer truncate`}
                >
                  {item}
                </motion.div>
              ))}
          ...
          <div className="mt-8 sm:mt-10 md:mt-12 lg:mt-16 xl:mt-20">
            <div className="flex flex-col sm:flex-row items-center justify-between mb-4 sm:mb-6 gap-2 sm:gap-3">
              ...
              <button 
                ...
                className={`${selectedColor.text} text-[10px] xs:text-xs sm:text-sm hover:${selectedColor.text} transition px-2 py-1 sm:px-3 rounded-full border ${selectedColor.border}/30 hover:${selectedColor.border}`}
              >
            ...
            <div className="relative overflow-x-hidden">
              <div className={`absolute left-0 top-0 bottom-0 w-8 xs:w-12 sm:w-16 md:w-20 bg-gradient-to-r from-${selectedColor.bgMask} via-${selectedColor.bgMask}/50 to-transparent z-10 pointer-events-none`} />
              <div className={`absolute right-0 top-0 bottom-0 w-8 xs:w-12 sm:w-16 md:w-20 bg-gradient-to-l from-${selectedColor.bgMask} via-${selectedColor.bgMask}/50 to-transparent z-10 pointer-events-none`} />
              ...
              >
                {[...counselors, ...counselors].map((c, i) => (
                  <motion.div
                    ...
                    className={`w-32 xs:w-36 sm:w-40 md:w-44 lg:w-48 xl:w-52 bg-gradient-to-br from-gray-800 to-gray-900 rounded-lg sm:rounded-xl p-2 sm:p-3 md:p-4 text-center border border-gray-600 ${selectedColor.borderHover} transition-all duration-300 cursor-pointer shadow-xl`}
                  >
                    <div className="relative w-10 h-10 xs:w-12 xs:h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 mx-auto">
                      <div className={`absolute inset-0 bg-gradient-to-r ${selectedColor.from} ${selectedColor.to} rounded-full blur-md opacity-60`} />
                      <Image
                        src={c.image}
                        alt={c.name}
                        width={64}
                        height={64}
                        className={`rounded-full object-cover relative z-10 border-2 ${selectedColor.border} w-full h-full`}
                      />
                    ...
                    <p className={`${selectedColor.text} text-[8px] xs:text-[10px] sm:text-xs mt-0.5`}>{c.tag}</p>
                    <div className="flex items-center justify-center gap-0.5 xs:gap-1 mt-1 xs:mt-1.5">
                      <Star className={`w-2 h-2 xs:w-2.5 xs:h-2.5 ${selectedColor.text} ${selectedColor.fill}`} />
        ...
        <div className="absolute bottom-4 sm:bottom-6 left-1/2 transform -translate-x-1/2 hidden sm:block z-20">
          <div className="w-4 h-7 sm:w-5 sm:h-8 border-2 border-gray-600 rounded-full flex justify-center">
            <div className={`w-0.5 h-1 sm:w-1 sm:h-1.5 ${selectedColor.text} rounded-full mt-1 sm:mt-1.5 animate-bounce`} />
          </div>
        </div>
      </section>
