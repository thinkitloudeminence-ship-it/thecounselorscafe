...
export default function HeroSection() {
  ...
  // Gold color gradient
  const goldGradient = "from-amber-400 to-amber-600";
  const goldColor = "#fbbf24"; // amber-400
  const goldDark = "#d97706"; // amber-600
  ...
  return (
    <>
      <section
        ...
        style={{ backgroundColor: "#0a192f" }} // Navy Blue color
      >
        {/* Animated Background Glow - Hidden on mobile */}
        <motion.div
          animate={{ scale: [1, 1.2, 1], opacity: [0.3, 0.5, 0.3] }}
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8 md:py-12 lg:py-16 relative z-10">
            ...
            <div className="relative z-20 p-5 sm:p-6 md:p-8 lg:p-10 xl:p-12 bg-gradient-to-r from-black/70 via-black/50 to-transparent">
              <div className="flex flex-col lg:flex-row items-center lg:items-start justify-between gap-8 lg:gap-12">
                ...
                >
                  ...
                  <button 
                    onClick={() => setAppModal(true)}
                    className="mt-5 sm:mt-6 md:mt-7 bg-gradient-to-r from-amber-500 to-amber-600 text-black px-4 sm:px-5 md:px-6 lg:px-8 py-2 sm:py-2.5 md:py-3 rounded-full font-semibold hover:from-amber-400 hover:to-amber-500 transition-all duration-300 text-xs sm:text-sm md:text-base inline-flex items-center gap-1.5 sm:gap-2 group shadow-lg"
                  >
                    Talk to Expert 
                    <ChevronRight className="w-3 h-3 sm:w-4 sm:h-4 group-hover:translate-x-1 transition-transform" />
                  </button>
          ...
          <div className="mt-6 sm:mt-8 md:mt-10 lg:mt-12 max-w-xl sm:max-w-2xl md:max-w-3xl mx-auto">
            <div className="flex flex-col sm:flex-row gap-2 bg-gray-900/80 backdrop-blur-sm rounded-xl sm:rounded-2xl p-1 border border-gray-700">
              ...
              <button className="bg-gradient-to-r from-amber-500 to-amber-600 text-black px-4 sm:px-5 md:px-6 py-2 sm:py-2.5 md:py-3 rounded-lg sm:rounded-xl text-xs sm:text-sm md:text-base font-semibold hover:from-amber-400 hover:to-amber-500 transition-all duration-300 inline-flex items-center justify-center gap-1.5 sm:gap-2">
                <Search className="w-3.5 h-3.5 sm:w-4 sm:h-4" />
                Search
              </button>
            </div>
          ...
          <div className="mt-8 sm:mt-10 md:mt-12 lg:mt-16 xl:mt-20">
            <div className="flex flex-col sm:flex-row items-center justify-between mb-4 sm:mb-6 gap-2 sm:gap-3">
              ...
              <button 
                onClick={() => setAutoScroll(!autoScroll)}
                className="text-amber-500 text-[10px] xs:text-xs sm:text-sm hover:text-amber-400 transition px-2 py-1 sm:px-3 rounded-full border border-amber-500/30 hover:border-amber-500"
              >
                {autoScroll ? "⏸ Pause" : "▶ Auto-scroll"}
              </button>
            </div>
            ...
            <div className="relative overflow-x-hidden">
              {/* Gradient masks */}
              <div className="absolute left-0 top-0 bottom-0 w-8 xs:w-12 sm:w-16 md:w-20 bg-gradient-to-r from-[#0a192f] via-[#0a192f]/50 to-transparent z-10 pointer-events-none" />
              <div className="absolute right-0 top-0 bottom-0 w-8 xs:w-12 sm:w-16 md:w-20 bg-gradient-to-l from-[#0a192f] via-[#0a192f]/50 to-transparent z-10 pointer-events-none" />
              ...
              >
                {[...counselors, ...counselors].map((c, i) => (
                  <motion.div
                    key={i}
                    whileHover={{ scale: 1.05, y: -5 }}
                    className="w-32 xs:w-36 sm:w-40 md:w-44 lg:w-48 xl:w-52 bg-gradient-to-br from-gray-800 to-gray-900 rounded-lg sm:rounded-xl p-2 sm:p-3 md:p-4 text-center border border-gray-600 hover:border-amber-500 transition-all duration-300 cursor-pointer shadow-xl"
                  >
                    <div className="relative w-10 h-10 xs:w-12 xs:h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 mx-auto">
                      <div className="absolute inset-0 bg-gradient-to-r from-amber-500 to-amber-600 rounded-full blur-md opacity-60" />
                      <Image
                        src={c.image}
                        alt={c.name}
                        width={64}
                    ...
                    <p className="text-amber-500 text-[8px] xs:text-[10px] sm:text-xs mt-0.5">{c.tag}</p>
                    <div className="flex items-center justify-center gap-0.5 xs:gap-1 mt-1 xs:mt-1.5">
        ...
        <div className="absolute bottom-4 sm:bottom-6 left-1/2 transform -translate-x-1/2 hidden sm:block z-20">
          <div className="w-4 h-7 sm:w-5 sm:h-8 border-2 border-gray-600 rounded-full flex justify-center">
            <div className="w-0.5 h-1 sm:w-1 sm:h-1.5 bg-amber-500 rounded-full mt-1 sm:mt-1.5 animate-bounce" />
          </div>
        </div>
      </section>
