      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        <div className="text-center mb-16">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-yellow-50 border border-yellow-200 mb-4">
            ...
            <span className="text-yellow-600 text-xs font-semibold tracking-wider">✦ TRANSFORMATIVE SERVICES ✦</span>
          </div>
          ...
          {services.map((s) => (
            <div key={s.title} className="perspective-1000">
              <Link href={s.href} className="block relative group">
                ...
                <div className="relative bg-white border border-gray-200 rounded-2xl p-6 hover:border-yellow-500/50 transition-all duration-500 h-full overflow-hidden shadow-lg hover:shadow-xl">
        ...
        {/* <div className="absolute -top-20 left-10 w-32 h-32 bg-gradient-to-r from-yellow-500/10 to-transparent rounded-full blur-3xl pointer-events-none" />
        <div className="absolute -bottom-20 right-10 w-40 h-40 bg-gradient-to-l from-yellow-500/10 to-transparent rounded-full blur-3xl pointer-events-none" /> */}
      </div>
    </section>
  );
}