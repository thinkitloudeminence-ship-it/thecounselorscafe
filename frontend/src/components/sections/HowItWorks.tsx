    ...
    <section ref={sectionRef} className="py-16 md:py-24 bg-white relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        <motion.div
          ...
          className="absolute -top-40 left-1/4 w-80 h-80 bg-yellow-500/10 rounded-full blur-[100px]"
        />
        <motion.div
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        ...
        <div className="text-center mb-16">
          <motion.div
            ...
            className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-yellow-50 border border-yellow-200 mb-4"
          >
            <Sparkles size={14} className="text-yellow-500" />
            <span className="text-yellow-600 text-xs font-semibold tracking-wide">SIMPLE PROCESS</span>
          </motion.div>
            ...
            >
              <div className="flex flex-col items-center text-center group">
                ...
                >
                  ...
                  <div className="relative w-28 h-28 rounded-2xl bg-gradient-to-br from-white to-gray-50 border-2 border-yellow-200 flex flex-col items-center justify-center shadow-xl group-hover:border-yellow-500 group-hover:shadow-yellow-500/20 transition-all duration-300">
                    <motion.div
                ...
                <motion.h3
                  ...
                  className="text-gray-900 font-bold text-xl mb-3 group-hover:text-yellow-500 transition-colors duration-300"
                >
                  {step.title}
                </motion.h3>
        ...
        >
          ...
          >
            <a
              href="/counselors"
              className="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-gradient-to-r from-yellow-500 to-yellow-600 text-white font-semibold text-sm hover:shadow-lg hover:shadow-yellow-500/25 transition-all duration-300"
            >
